...
"</style>");
            ...
            out.println("<div class='row'><div class='col-25'>ID</div><div class='col-75'><input type='number' name='id' required></div></div>"
                    + ""
                    + "<div class='row col-25'><input type='submit' value='submit'></div>"
